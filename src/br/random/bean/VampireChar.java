...
public class VampireChar extends Char {
	...
	public static VampireChar getByCharId(Context context, int id) {
		VampireChar ret = null;
		SQLiteDatabase db = (new DatabaseHelper(context)).getWritableDatabase();
		try {
		    Cursor cursor = db.query("tbchar_vampire", null, "idchar = ?", new String[] { ""+id }, null, null, null);
		    if (cursor.moveToNext()) {
		    	ret = new VampireChar();
				ret.setUserid(cursor.getInt(1));
				ret.setName(cursor.getString(2));
				ret.setNature(cursor.getString(3));
				ret.setDemeanor(cursor.getString(4));
				ret.setClan(cursor.getString(5));
				ret.setGeneration(cursor.getInt(6));
				ret.setHaven(cursor.getString(7));
				ret.setConcept(cursor.getString(8));
				ret.setStrength(cursor.getInt(9));
				ret.setDexterity(cursor.getInt(10));
				ret.setStamina(cursor.getInt(11));
				ret.setCharisma(cursor.getInt(12));
				ret.setManipulation(cursor.getInt(13));
				ret.setAppearance(cursor.getInt(14));
				ret.setPerception(cursor.getInt(15));
				ret.setIntelligence(cursor.getInt(16));
				ret.setWits(cursor.getInt(17));
				ret.setActing(cursor.getInt(18));
				ret.setAlertness(cursor.getInt(19));
				ret.setAthletics(cursor.getInt(20));
				ret.setBrawl(cursor.getInt(21));
				ret.setDodge(cursor.getInt(22));
				ret.setEmpathy(cursor.getInt(23));
				ret.setIntimidation(cursor.getInt(24));
				ret.setLeadership(cursor.getInt(25));
				ret.setStreetwise(cursor.getInt(26));
				ret.setSubterfuge(cursor.getInt(27));
				ret.setAnimalken(cursor.getInt(28));
				ret.setDrive(cursor.getInt(29));
				ret.setEtiquette(cursor.getInt(30));
				ret.setFirearms(cursor.getInt(31));
				ret.setMelee(cursor.getInt(32));
				ret.setMusic(cursor.getInt(33));
				ret.setRepair(cursor.getInt(34));
				ret.setSecurity(cursor.getInt(35));
				ret.setStealth(cursor.getInt(36));
				ret.setSurvival(cursor.getInt(37));
				ret.setBureaucracy(cursor.getInt(38));
				ret.setComputer(cursor.getInt(39));
				ret.setFinance(cursor.getInt(40));
				ret.setInvestigation(cursor.getInt(41));
				ret.setLaw(cursor.getInt(42));
				ret.setLinguistics(cursor.getInt(43));
				ret.setMedicine(cursor.getInt(44));
				ret.setOccult(cursor.getInt(45));
				ret.setPolitics(cursor.getInt(46));
				ret.setScience(cursor.getInt(47));
				ret.setDiscipline1(cursor.getString(48));
				ret.setDiscipline1val(cursor.getInt(49));
				ret.setDiscipline2(cursor.getString(50));
				ret.setDiscipline2val(cursor.getInt(51));
				ret.setDiscipline3(cursor.getString(52));
				ret.setDiscipline3val(cursor.getInt(53));
				ret.setDiscipline4(cursor.getString(54));
				ret.setDiscipline4val(cursor.getInt(55));
				ret.setDiscipline5(cursor.getString(56));
				ret.setDiscipline5val(cursor.getInt(57));
				ret.setBackground1(cursor.getString(58));
				ret.setBackground1val(cursor.getInt(59));
				ret.setBackground2(cursor.getString(60));
				ret.setBackground2val(cursor.getInt(61));
				ret.setBackground3(cursor.getString(62));
				ret.setBackground3val(cursor.getInt(63));
				ret.setBackground4(cursor.getString(64));
				ret.setBackground4val(cursor.getInt(65));
				ret.setBackground5(cursor.getString(66));
				ret.setBackground5val(cursor.getInt(67));
				ret.setConscience(cursor.getInt(68));
				ret.setSelfcontrol(cursor.getInt(69));
				ret.setCourage(cursor.getInt(70));
				ret.setTrait1(cursor.getString(71));
				ret.setTrait1val(cursor.getInt(72));
				ret.setTrait2(cursor.getString(73));
				ret.setTrait2val(cursor.getInt(74));
				ret.setTrait3(cursor.getString(75));
				ret.setTrait3val(cursor.getInt(76));
				ret.setTrait4(cursor.getString(77));
				ret.setTrait4val(cursor.getInt(78));
				ret.setTrait5(cursor.getString(79));
				ret.setTrait5val(cursor.getInt(80));
				ret.setWeapon1(cursor.getString(81));
				ret.setWeapon1diff(cursor.getInt(82));
				ret.setWeapon1dam(cursor.getInt(83));
				ret.setWeapon2(cursor.getString(84));
				ret.setWeapon2diff(cursor.getInt(85));
				ret.setWeapon2dam(cursor.getInt(86));
				ret.setWeapon3(cursor.getString(87));
				ret.setWeapon3diff(cursor.getInt(88));
				ret.setWeapon3dam(cursor.getInt(89));
				ret.setHumanity(cursor.getInt(90));
				ret.setWillpower(cursor.getInt(91));
				ret.setWillpowercur(cursor.getInt(92));
				ret.setBloodpool(cursor.getInt(93));
				ret.setHealth(cursor.getString(94));
				ret.setExperience(cursor.getInt(95));
				ret.setExperiencecur(cursor.getInt(96));
				ret.setPhysicLeft(0);
				ret.setSocialLeft(0);
				ret.setMentalLeft(0);
				ret.setTalentLeft(0);
				ret.setSkillLeft(0);
				ret.setKnowledgeLeft(0);
				ret.setDisciplineLeft(0);
				ret.setBackgroundLeft(0);
				ret.setVirtueLeft(0);
		    }
		} catch (Exception e) { }
