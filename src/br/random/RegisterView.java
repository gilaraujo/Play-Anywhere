...
public class RegisterView extends SherlockActivity {
	...
	private TableLayout tl_systems;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tl_contacts = (TableLayout)findViewById(R.id.tl_contacts);
        tl_systems = (TableLayout)findViewById(R.id.tl_systems);
        et_name = (EditText)findViewById(R.id.et_name);
        et_birthdate = (EditText)findViewById(R.id.et_birthdate);
        et_city = (EditText)findViewById(R.id.et_city);
        et_nick = (EditText)findViewById(R.id.et_nick);
        et_pass = (EditText)findViewById(R.id.et_pass);
        iv_picture = (ImageView)findViewById(R.id.iv_profile);
        ...
        try {
        	et_birthdate.setText(savedInstanceState.getString("birthdate"));
        } catch (Exception e) {
        }
        try {
        ...
        try {
        	et_nick.setText(savedInstanceState.getString("nick"));
        } catch (Exception e) {
        }
        try {
        ...
        for (int i=0; i<size; i++) {
        	addContact(tl_contacts, savedInstanceState.getInt("ctype"+i), savedInstanceState.getString("ctext"+i));
        }
        try {
        ...
        for (int i=0; i<size; i++) {
        	addSystem(tl_systems, savedInstanceState.getInt("stype"+i));
        }
        ...
        ok.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
		        ...
		        profile.setBirthdate(et_birthdate.getText().toString());
		        profile.setCity(et_city.getText().toString());
		        profile.setNickname(et_nick.getText().toString());
		        profile.setPassword(et_pass.getText().toString());
		        profile.setPicture(Convert.ImageViewToByteArray(iv_picture));
		        
		        List<ContactInfo> contactsData = new ArrayList<ContactInfo>();
		        for(int i = 0; i < tl_contacts.getChildCount(); i++){
		        	TableRow row = (TableRow)tl_contacts.getChildAt(i);
		        ...
		        for(int i = 0; i < tl_systems.getChildCount(); i++){
		        	TableRow row = (TableRow)tl_systems.getChildAt(i);
    ...
    protected void onSaveInstanceState(Bundle icicle) {
    	...
    	icicle.putString("birthdate", birthdate);
    	icicle.putString("city", city);
    	icicle.putString("nick", nick);
    	icicle.putString("pass", pass);
    	...
    	if (hasProfileImage) icicle.putByteArray("profile", Convert.ImageViewToByteArray(iv_picture));
    }
