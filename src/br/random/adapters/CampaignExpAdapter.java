...
public class CampaignExpAdapter extends BaseExpandableListAdapter
{
                             ...
                             View convertView, ViewGroup parent) 
    {
        ...
        TextView quest = (TextView)row.findViewById(R.id.tv_quest_name);
        // Indent
    ...
    public View getGroupView(int groupPos, boolean isExpanded, View convertView, ViewGroup parent) 
    {
        ...
        TextView campaignId = (TextView)row.findViewById(R.id.tv_campaign_id);
        TextView campaignName = (TextView)row.findViewById(R.id.tv_campaign_name);
        TextView charName = (TextView)row.findViewById(R.id.tv_char_name);
        // Indent
